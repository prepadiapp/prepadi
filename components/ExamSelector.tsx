...
import { Calendar, ChevronRight, BookOpen, Target, Clock, Zap, CheckCircle2 } from 'lucide-react';
...
function ExamSelectorContent({ exams }: ExamSelectorProps) {
  ...
  const handleStartExam = () => {
    ...
    router.push(`/quiz/${examSlug}/${subjectSlug}/${selectedYear}?mode=${mode}`);
  };
  ...
  return (
    <Card className="w-full border-slate-200 shadow-sm bg-white">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Step 1: Exam & Subject Row (Responsive Grid) */}
        ...
        {/* Step 4: Mode Selection (Visual Cards) */}
        {step === 'year' && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    >
                        ...
                        <p className="text-xs text-slate-500 leading-relaxed">
                            Untimed. See answers immediately. Best for learning new topics.
                        </p>
                    </div>
