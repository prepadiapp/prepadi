...
import { getAllOfflineExams } from '@/lib/offline-storage';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { WifiOff, Play, Trash2, Clock } from 'lucide-react';
...
export default function OfflineDashboard() {
  ...
  if (loading) return <div className="p-8 text-center">Loading downloads...</div>;
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
            ...
            <p className="text-slate-500">Access your downloaded papers without internet.</p>
        </div>
      </div>
        ...
        <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-slate-500 max-w-sm mt-2">
                    Go to the "Practice" tab while online to download exams for offline use.
                </p>
                <Button variant="outline" className="mt-6" onClick={() => router.push('/dashboard/practice')}>
                    Go to Practice
                </Button>
            </CardContent>
        </Card>
